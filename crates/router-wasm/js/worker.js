 ...
 *
 * wasm-pack --target bundler の router_wasm.js は
 *   import * as wasm from "./router_wasm_bg.wasm";
...
import wasmModule from './router_wasm_bg.wasm';
import * as bg from './router_wasm_bg.js';
...
function ensureInitialized() {
  ...
  try {
    ...
    // __wbg_* / __wbindgen_* 関数群を './router_wasm_bg.js' namespace で渡す。
    const instance = new WebAssembly.Instance(wasmModule, {
      './router_wasm_bg.js': bg
    });
